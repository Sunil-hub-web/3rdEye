...
import com.example.a3rdeye.enabler.registration.SignupOrKYC_Enabler;

public class Declaration_Page3_Enabler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration__page3__enabler);
                    ...
                    checkBox2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                            ...
                            if (checkBox2.isChecked()) {
                                ...
                                Toast.makeText(Declaration_Page3_Enabler.this, "Select All The CheckBox", Toast.LENGTH_SHORT).show();
        ...
        btn_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox1.isChecked() && checkBox2.isChecked() && checkBox3.isChecked()) {
                    ...
                    Intent intent = new Intent(Declaration_Page3_Enabler.this, SignupOrKYC_Enabler.class);
