...
public class Declaration_Page2_Enabler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration__page2__enabler);
        ...
        checkBox1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (checkBox1.isChecked()) {
                    ...
                    Toast.makeText(Declaration_Page2_Enabler.this, "Select All The CheckBox", Toast.LENGTH_SHORT).show();
        ...
        btn_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox1.isChecked() && checkBox2.isChecked()) {
                    ...
                    Intent intent = new Intent(Declaration_Page2_Enabler.this, Declaration_Page3_Enabler.class);
