...
public class GoldFragement extends Fragment {
    ...
    Context context;
    String services,services1,service,frequency,duration,price,name;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.gold, container, false);

        getDataGold();

        btn_Gold = view.findViewById(R.id.btngold);
        ...
        text_Name = view.findViewById(R.id.gold);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(s1 != null){
                        ...
                        Toast.makeText(getActivity(), "Gold Is Selected", Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    e.printStackTrace();
                }
    ...
    public void onResume() {
       ...
       /* SharedPreferences sp = getActivity().getSharedPreferences("details", context.MODE_PRIVATE);
        ...
        if(s1 != null){
            ...
            btn_Gold.setVisibility(View.GONE);
        }
        else{
            btn_Gold.setVisibility(View.VISIBLE);
        }*/
